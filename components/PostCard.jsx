    ...
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pd-12 mb-8'>
      ...
      <div className='text-center'>
        <Link href={`/post/${post.slug}`}>
          <span className='transition duration-500 transform hover:-translate-y-1 inline-block bg-pink-600 text-lg font-medium rounded-full text-white px-8 px-30 cursor-pointer'>
            Continue Reading
          </span>
        </Link>
      </div>
